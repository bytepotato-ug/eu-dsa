 ...
 */
export function calculatePriority(basePriority, isTrustedFlagger, config) {
 ...
 */
export function evaluateFlaggerStatus(stats, config) {
    const cfg = { ...DEFAULT_CONFIG, ...config };
 ...
 */
export function applyCommunityBonus(basePriority, reporterCount, options) {
...
//# sourceMappingURL=trusted-flagger.js.map