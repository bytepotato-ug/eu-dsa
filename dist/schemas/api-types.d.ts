 ...
 */
import type { AccountType, AutomatedDecision, AutomatedDetection, Category, CategorySpecification, ContentType, DecisionAccount, DecisionGround, DecisionMonetary, DecisionProvision, DecisionVisibility, IncompatibleContentIllegal, SourceType, TerritorialScopeCode } from './enums.js';
