 ...
 */
import { z } from 'zod';
import { AccountType, AutomatedDecision, Category, CategorySpecification, ContentType, DecisionAccount, DecisionGround, DecisionMonetary, DecisionProvision, DecisionVisibility, SourceType, TerritorialScope, enumValues, } from './enums.js';
const dateRegex = /^\d{4}-\d{2}-\d{2}$/;
const puidRegex = /^[a-zA-Z0-9\-_]+$/;
const ean13Regex = /^[0-9]{13}$/;
const dateField = (label) => z.string({ required_error: `${label} is required` })
...
export const sorSubmissionSchema = z.object({
    ...
    // Scope
    territorial_scope: z.array(z.enum(TerritorialScope)).min(1, 'At least one territorial_scope is required'),
...
//# sourceMappingURL=sor-schema.js.map